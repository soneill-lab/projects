...
for (i in 1:10) {
  ADG_temp<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_A/yd.Yorkshire.ADG_add.CV", i, ".variance.components.model.csv", sep=""), header = T, sep=",")
  ADG_temp_N<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_A/Yorkshire.ADG_N", i, ".csv", sep=""), header = F)
 ...
 write.table(p, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_A/ADG",i,"_p.csv", sep=""), quote = F, col.names = F, row.names = F)
 ...
 ADG_Finisher_temp_N<- as.data.frame(ADG_temp_N)
  ...
  # adjust by F
  ADG_Adj<- read.table("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_A/yd.Yorkshire.ADG_add.CV.Adj.variance.components.model.csv", header = T, sep=",")
  ...
  write.table(y_temp, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_A/ADG",i,"_y.csv", sep=""), quote = F, col.names = F, row.names = F, sep=",")
