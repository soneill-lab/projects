...
for (i in 1:10) {
  ADG_temp<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/yd.Yorkshire_ADG_Nursery_full.CV",i,".variance.components.model.csv", sep=""), header = T, sep=",")
  ADG_temp_N<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/Yorkshire_ADG_Nursery_N",i,".csv", sep=""), header = F)
 ...
 # write.table(p, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/ADG_Nursery",i,"_p.csv", sep=""), quote = F, col.names = F, row.names = F)
  ...
  # adjust by F
  ADG_Adj<- read.table("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/yd.Yorkshire.ADG_Nursery_full.CV.Adj.variance.components.model.csv", header = T, sep=",")
  ...
  # write.table(y_temp, file=paste(/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/ADG_Nursery",i,"_y.csv", sep=""), quote = F, col.names = F, row.names = F, sep=",")
  # 
...
write.table(Acc, file="/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Nursery_F/ADG_Nursery_Acc_epi.csv", quote = F, col.names = F, row.names = F, sep=",")
