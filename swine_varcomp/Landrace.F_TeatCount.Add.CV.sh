...
do 
# Get PEBV
./mmap --ped pedigree.file --phenotype_filename Landrace_BirthTotalTeatCount_females_Filtered --trait yd --covariate_filename Landrace.IBC.csv --covariates F  --estimate_variance_components --variance_component_filename Landrace.add.grm.bin Landrace.sow.i.bin --subject_set Landrace.F_TeatCount_T$data.csv --variance_component_label A S --file_suffix Landrace.F_TeatCount_add.CV$data --num_mkl_threads 20 --num_em_reml_burnin 2 --use_em_ai_reml --single_pedigree --use_dpotrs

done

# Get inbreeding effect
./mmap --ped pedigree.file --phenotype_filename Landrace_BirthTotalTeatCount_females_Filtered --trait yd --covariate_filename Landrace.IBC.csv --covariates F  --estimate_variance_components --variance_component_filename Landrace.add.grm.bin Landrace.sow.i.bin --variance_component_label A S --file_suffix Landrace.F_TeatCount_add.CV.Adj --num_mkl_threads 20 --num_em_reml_burnin 2 --use_em_ai_reml --single_pedigree --use_dpotrs
