...
for (i in 1:10) {
  ADG_temp<- read.table(paste("/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_A/yd.Landrace_ADG_add.CV", i, ".variance.components.model.csv", sep=""), header = T, sep=",")
  ADG_temp_N<- read.table(paste("/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_A/Landrace_ADG_N", i, ".csv", sep=""), header = F)
