...
for (i in 1:10) {
  ADG_Finisher_temp<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/yd.yorkshire.ADG_Finisher_add.CV", i, ".variance.components.model.csv", sep=""), header = T, sep=",")
  ADG_Finisher_temp_N<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/yorkshire.ADG_Finisher_N", i, ".csv", sep=""), header = F)
 ...
 write.table(a, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/ADG_Finisher","_a.csv", sep=""), quote = F, col.names = F, row.names = F)
 ...
 write.table(p, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/ADG_Finisher",i,"_p.csv", sep=""), quote = F, col.names = F, row.names = F)
  
  # get phenotype
  y<- read.table("Yorkshire_ADG_Finisher_Filtered", header = T, sep = ",")
  names(y)<- c("ID", "yd")
 ADG_Finisher_temp_N<- as.data.frame(ADG_Finisher_temp_N)
  ...
  # adjust by F
  ADG_Finisher_Adj<- read.table("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/yd.yorkshire.ADG_Finisher_add.CV.Adj.variance.components.model.csv", header = T, sep=",")
  ...
  write.table(y_temp, file=paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/ADG_Finisher",i,"_y.csv", sep=""), quote = F, col.names = F, row.names = F, sep=",")
...
write.table(Acc, file="/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_Finisher_A/ADG_Finisher_Acc.csv", quote = F, col.names = F, row.names = F, sep=",")
