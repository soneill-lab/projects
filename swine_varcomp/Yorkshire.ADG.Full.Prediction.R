...
for (i in 1:10) {
  ADG_temp<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_F/yd.Yorkshire.ADG_full.CV",i,".variance.components.model.csv", sep=""), header = T, sep=",")
  ADG_temp_N<- read.table(paste("/home/varcomp/Yorkshire_Breed/Cross_Validation/ADG_F/Yorkshire.ADG_N",i,".csv", sep=""), header = F)
