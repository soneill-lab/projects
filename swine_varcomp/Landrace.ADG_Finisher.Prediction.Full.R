...
for (i in 1:10) {
 ...
 # write.table(p, file=paste("/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_Finisher_F/ADG_Finisher",i,"_p.csv", sep=""), quote = F, col.names = F, row.names = F)
  ...
  # adjust by F
  ADG_Adj<- read.table("/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_Finisher_F/yd.Landrace.ADG_Finisher_full.CV.Adj.variance.components.model.csv", header = T, sep=",")
  ...
  # write.table(y_temp, file=paste(/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_Finisher_F/ADG_Finisher",i,"_y.csv", sep=""), quote = F, col.names = F, row.names = F, sep=",")
  # 
...
write.table(Acc, file="/home/varcomp/Landrace_Breed/New_Pipeline/New_Phenotypes/Cross_Validation/ADG_F/ADG_Finisher_Acc_epi.csv", quote = F, col.names = F, row.names = F, sep=",")
